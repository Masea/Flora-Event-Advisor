...
//app.use(cors({ origin: 'http://ec2-user@ec2-35-175-231-64.compute-1.amazonaws.com', credentials: true }));
...
app.use(function(req, res, next){
    //res.setHeader('Access-Control-Allow-Origin', 'http://ec2-user@ec2-35-175-231-64.compute-1.amazonaws.com');
